...
docker cp samplelaravelreactapp_laravel.test_1:%var% > Dockerlogs/log.txt && ^ docker cp  samplelaravelreactapp_laravel.test_1:tmp/logs.json Dockerlogs/tmp_Log.txt
