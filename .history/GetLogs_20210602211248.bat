...
if not "%CID%" == "1" then ( ECHO "Container doesn't exist") else ( docker-compose logs -t > Dockerlogs/Container_log.log & docker stats --no-stream  > Dockerlogs/DockerStats.log)
