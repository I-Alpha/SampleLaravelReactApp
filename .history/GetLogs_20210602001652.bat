...
docker logs -f samplelaravelreactapp_laravel.test_1 > Dockerlogs/Container_log.txt 2>&1 &&  docker cp -a samplelaravelreactapp_laravel.test_1:%var% > Dockerlogs/log.txt && ^ 
