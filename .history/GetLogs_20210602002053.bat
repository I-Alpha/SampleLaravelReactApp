...
docker cp --format --no-stream samplelaravelreactapp_laravel.test_1:%var% > Dockerlogs/log.txt && ^ docker cp  samplelaravelreactapp_laravel.test_1:tmp Dockerlogs/tmp
docker stats -a samplelaravelreactapp_laravel.test_1 > Dockerlogs/DockerStats.txt