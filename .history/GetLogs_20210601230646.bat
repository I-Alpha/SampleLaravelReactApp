...
if "%1"=="file" (docker logs samplelaravelreactapp_laravel.test_1 >> /Dockerlogs/Container_log.txt && open %var% >> /Dockerlogs/log.txt && exit) ^ else 

if "%1"=="file"(docker logs  samplelaravelreactapp_laravel.test_1 >> /Dockerlogs/Container_log.txt 
