A Sample Webapp using Laravel 8 as back-end, React as front end and a MYSQL databse. The project is deployed using  docker, with a docker compose file  with  a few dependencies 
