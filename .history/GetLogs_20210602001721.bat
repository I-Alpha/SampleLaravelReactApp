...
docker logs samplelaravelreactapp_laravel.test_1 > Dockerlogs/Container_log.txt 2>&1 &&  docker cp samplelaravelreactapp_laravel.test_1:%var% > Dockerlogs/log.txt && ^ 
docker cp  samplelaravelreactapp_laravel.test_1:tmp/logs.json Dockerlogs/tmp_Log.txt
docker stats samplelaravelreactapp_laravel.test_1 > Dockerlogs/DockerStats.txtY